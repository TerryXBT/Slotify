...
export default async function AvailabilityPage() {
  ...
  const getRuleForDay = (dayId: number) =>
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-neutral-900 font-sans pb-24 text-gray-900 dark:text-gray-100">
      <header className="sticky top-0 z-30 bg-white/90 dark:bg-neutral-900/90 backdrop-blur-md px-5 pt-12 pb-4 flex items-center justify-between border-b border-gray-200 dark:border-gray-800">
        ...
        <button
          type="submit"
          form="avail-form"
          className="text-blue-600 dark:text-blue-500 font-bold text-base"
        >
          Save
        </button>
      </header>
      ...
      <main className="px-5 mt-4">
        <form id="avail-form" action={updateAvailability} className="space-y-6">
          ...
          <p className="text-center text-gray-500 dark:text-gray-400 text-sm px-4">
            These settings apply to your recurring weekly schedule. You can
            block specific dates using &quot;Busy Blocks&quot;.
          </p>
        </form>
      </main>
    </div>
