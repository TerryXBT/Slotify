...
export default function TimeSlotSelector({ slots, selectedTime, onTimeSelect, loading }: TimeSlotSelectorProps) {
    if (loading) {
        return (
    ...
    if (slots.length === 0) {
        return (
            <div className="bg-[#1C1C1E] rounded-[14px] p-8 flex flex-col items-center justify-center">
                ...
                <p className="text-[17px] font-medium text-gray-400 mb-1">No Available Times</p>
