...
export default function BookingPageSettings({
  ...
  return (
    <div className="min-h-screen bg-neutral-900 pb-24">
      ...
      {/* Header */}
      <div className="sticky top-0 z-40 bg-neutral-900 border-b border-gray-800">
      ...
      >
        ...
        <div>
          ...
          <p className="text-xs text-gray-500 mt-1">
            This appears at the top of your booking page
          </p>
        </div>
        ...
        <div>
          ...
          />
          <p className="text-xs text-gray-500 mt-1">
            At least one contact method (location, phone, or email) recommended
          </p>
        </div>
