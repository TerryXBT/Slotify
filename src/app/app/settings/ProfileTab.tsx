            ...
            <form onSubmit={handleServiceSubmit} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  defaultValue={
                    editingService
                      ? services.find((s) => s.id === editingService)?.name
                      : ""
                  }
          ...
          <div className="relative bg-[#1C1C1E] rounded-2xl p-6 w-full max-w-sm shadow-xl animate-in zoom-in-95">
            <div className="text-center">
              ...
              <p className="text-gray-400 text-sm mb-6">
                ...
                will be moved to Recently Deleted. You can restore it later or
          ...
          <div className="relative bg-[#1C1C1E] rounded-2xl p-6 w-full max-w-sm shadow-xl animate-in zoom-in-95">
            <div className="text-center">
              ...
              <p className="text-gray-400 text-sm mb-4">
                ...
                <span className="font-medium text-white">
                  &quot;{permanentDeleteModal.serviceName}&quot;
                </span>
                ?
              </p>
              <div className="bg-red-900/30 border border-red-800/50 rounded-xl p-3 mb-6">
                <p className="text-red-400 text-xs">
                  ⚠️ This will also delete <strong>all bookings</strong>{" "}
                  associated with this service. This action cannot be undone.
                </p>
              </div>
            </div>
            <div className="flex gap-3">
