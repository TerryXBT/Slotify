...
export default function ServicesTab({ services }: { services: Service[] }) {
  ...
  const ServiceForm = ({
    ...
    const [locationType, setLocationType] = useState(
      initialData?.location_type || "physical",
    );
          ...
          <form onSubmit={onSubmit} className="space-y-4">
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full p-3 pl-9 rounded-xl bg-black border-none font-medium focus:ring-2 focus:ring-blue-500 text-white"
                  />
            ...
            <div>
              ...
              <input
                ...
                placeholder={
                  locationType === "physical"
                    ? "e.g. Downtown Studio, 123 Main St"
            ...
            <button
              disabled={loading}
              className="w-full bg-blue-600 hover:bg-blue-500 text-white font-bold py-3.5 rounded-xl mt-2 transition-all active:scale-[0.98]"
            >
          ...
          >
            <div className="flex-1 min-w-0">
              <div className="flex items-center gap-2">
                ...
                {!s.is_active && (
                  <span className="px-1.5 py-0.5 rounded bg-gray-700 text-gray-300 text-[10px] font-bold uppercase tracking-wide">
                    Inactive
                  </span>
                )}
              </div>
