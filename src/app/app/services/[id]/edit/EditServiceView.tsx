...
export default function EditServiceView({ service, profile, availabilitySettings }: EditServiceViewProps) {
    const router = useRouter()
    const [isSaving, setIsSaving] = useState(false)
    const [isDeleting, setIsDeleting] = useState(false)
    const [locationType, setLocationType] = useState(service.location_type || 'physical')
    const [isActive, setIsActive] = useState(service.is_active ?? true)
    const [priceNegotiable, setPriceNegotiable] = useState(service.price_negotiable ?? false)
            ...
            <div className="p-4 space-y-6">
                ...
                <div className="relative rounded-2xl overflow-hidden">
                    ...
                    <div className="relative z-10 px-4 py-3 border-b border-white/10">
                        <h2 className="text-[13px] text-gray-400 uppercase font-medium">Basic Information</h2>
                    </div>
                    ...
                    <div className="relative z-10 divide-y divide-white/5">
                        ...
                        <div className="px-4 py-3">
                            ...
                            <label className="flex items-center gap-3 mt-3 cursor-pointer">
                                ...
                                <span className="text-[15px] text-gray-300">Price negotiable</span>
                            </label>
                        </div>
                    </div>
                </div>
                ...
                <div className="relative rounded-2xl overflow-hidden">
                    ...
                    <div className="relative z-10 px-4 py-3 border-b border-white/10">
                        <h2 className="text-[13px] text-gray-400 uppercase font-medium">Location & Details</h2>
                    </div>
                ...
                <div className="relative rounded-2xl overflow-hidden">
                    ...
                    <div className="relative z-10 px-4 py-3 border-b border-white/10">
                        <h2 className="text-[13px] text-gray-400 uppercase font-medium">Booking Settings</h2>
                    </div>
                        ...
                        >
                            <div className="text-left">
                                <div className="text-[15px] text-gray-300">
                                    Buffer: {getBufferDisplayText()} · Cancel: {getCancellationDisplayText()}
                                </div>
                            ...
                            <div className="divide-y divide-white/5 border-t border-white/5">
                                ...
                                <div className="px-4 py-3">
                                    <div className="flex items-center gap-2 mb-3">
                                        <label className="text-[17px] text-white">Buffer Time</label>
                                        <InfoTooltip
                                            title="Buffer Time"
                                ...
                                <div className="px-4 py-3">
                                    <div className="flex items-center gap-2 mb-3">
                                        <label className="text-[17px] text-white">Cancellation Policy</label>
                                        <InfoTooltip
