...
export default function CreateServiceView({ profile, availabilitySettings }: CreateServiceViewProps) {
    const router = useRouter()
    const [isSaving, setIsSaving] = useState(false)
    const [locationType, setLocationType] = useState('physical')
    const [priceNegotiable, setPriceNegotiable] = useState(false)
    const [isBookingSettingsExpanded, setIsBookingSettingsExpanded] = useState(false)
    ...
    const defaultCancellation = availabilitySettings?.default_cancellation_policy ?? '24h'
    const [cancellationOption, setCancellationOption] = useState<string>(defaultCancellation)
        ...
        <div className="min-h-screen bg-[#1a1a1a] text-white font-sans selection:bg-blue-500/30">
            ...
            <div className="p-4 space-y-6 pb-24">
                ...
                <div className="space-y-2">
                    <h2 className="text-[13px] text-gray-400 uppercase font-medium tracking-wider ml-4">Basic Information</h2>
                    <div className="relative rounded-2xl overflow-hidden">
                        ...
                        <div className="relative z-10 divide-y divide-white/5">
                            ...
                            <div className="flex items-center px-4 py-3.5">
                                <label className="w-28 text-[17px] text-white font-medium">Name</label>
                                <input
                                    type="text"
                                    value={formData.name}
                            ...
                            <div className="px-4 py-3.5">
                                <div className="flex items-center justify-between mb-2">
                                    <label className="text-[17px] text-white font-medium">Description</label>
                            ...
                            <div className="flex items-center px-4 py-3.5">
                                <div className="flex items-center gap-2">
                                    <label className="text-[17px] text-white font-medium">Duration</label>
                                    <InfoTooltip
                                        title="Duration"
                            ...
                            <div className="px-4 py-3.5">
                                <div className="flex items-center justify-between">
                                    <div className="flex items-center gap-2">
                                        <label className="text-[17px] text-white font-medium">Price</label>
                                        <InfoTooltip
                                ...
                                <label className="flex items-center gap-3 mt-3 cursor-pointer group">
                                    ...
                                    <span className="text-[15px] text-gray-300 group-hover:text-white transition-colors">Price negotiable</span>
                                </label>
                            </div>
                        </div>
                    </div>
                ...
                <div className="space-y-2">
                    <h2 className="text-[13px] text-gray-400 uppercase font-medium tracking-wider ml-4">Location & Details</h2>
                    <div className="relative rounded-2xl overflow-hidden">
                        {/* Glassmorphism Background */}
                        <div className="absolute inset-0 bg-gradient-to-br from-white/[0.08] via-white/[0.05] to-white/[0.02] backdrop-blur-2xl" />
                        <div className="absolute inset-0 rounded-2xl border border-white/10" />
                ...
                <div className="space-y-2">
                    <h2 className="text-[13px] text-gray-400 uppercase font-medium tracking-wider ml-4">Booking Settings</h2>
                    <div className="relative rounded-2xl overflow-hidden">
                        {/* Glassmorphism Background */}
                        <div className="absolute inset-0 bg-gradient-to-br from-white/[0.08] via-white/[0.05] to-white/[0.02] backdrop-blur-2xl" />
                        <div className="absolute inset-0 rounded-2xl border border-white/10" />
                        ...
                        <div className="relative z-10">
                            ...
                            <button
                                type="button"
                                onClick={() => setIsBookingSettingsExpanded(!isBookingSettingsExpanded)}
                            ...
                            >
                                <div className="text-left">
                                    <div className="text-[15px] text-gray-200">
                                        Buffer: <span className="text-blue-400">{getBufferDisplayText()}</span>
                                        <span className="text-gray-500 mx-2">·</span>
                                        Cancel: <span className="text-blue-400">{getCancellationDisplayText()}</span>
                                    </div>
                                ...
                                <div className={clsx(
                                    "transition-all",
                                    isBookingSettingsExpanded ? "text-blue-400" : "text-gray-400"
                                )}>
                                ...
                                <div className="border-t border-white/5 px-4 py-3 space-y-4">
                                    ...
                                    <div>
                                        <div className="flex items-center justify-between mb-2">
                                            <div className="flex items-center gap-1.5">
                                                <span className="text-[15px] text-gray-300">Buffer Time</span>
                                                <InfoTooltip
                                                    title="Buffer Time"
                                    ...
                                    <div>
                                        <div className="flex items-center gap-1.5 mb-2">
                                            <span className="text-[15px] text-gray-300">Cancellation</span>
                                            <InfoTooltip
